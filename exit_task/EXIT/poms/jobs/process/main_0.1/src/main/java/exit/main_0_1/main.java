	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_1.put("folder", context.folder);
				paraList_tRunJob_1.add("--context_type " + "folder" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("TALEND_AdditionalParams",
						context.TALEND_AdditionalParams);
				paraList_tRunJob_1.add("--context_type "
						+ "TALEND_AdditionalParams" + "=" + "id_String");

				parentContextMap_tRunJob_1.put("TALEND_Login",
						context.TALEND_Login);
				paraList_tRunJob_1.add("--context_type " + "TALEND_Login" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("TALEND_Password",
						context.TALEND_Password);
				paraList_tRunJob_1.add("--context_type " + "TALEND_Password"
						+ "=" + "id_Password");

				parentContextMap_tRunJob_1.put("TALEND_Port",
						context.TALEND_Port);
				paraList_tRunJob_1.add("--context_type " + "TALEND_Port" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("TALEND_Schema",
						context.TALEND_Schema);
				paraList_tRunJob_1.add("--context_type " + "TALEND_Schema"
						+ "=" + "id_String");

				parentContextMap_tRunJob_1.put("TALEND_Server",
						context.TALEND_Server);
				paraList_tRunJob_1.add("--context_type " + "TALEND_Server"
						+ "=" + "id_String");

				parentContextMap_tRunJob_1.put("TALEND_ServiceName",
						context.TALEND_ServiceName);
				paraList_tRunJob_1.add("--context_type " + "TALEND_ServiceName"
						+ "=" + "id_String");
				...
				exit.load_wrk_0_1.load_wrk childJob_tRunJob_1 = new exit.load_wrk_0_1.load_wrk();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				exit.create_dim_tables_0_1.create_dim_tables childJob_tRunJob_2 = new exit.create_dim_tables_0_1.create_dim_tables();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				exit.load_dim_0_1.load_dim childJob_tRunJob_3 = new exit.load_dim_0_1.load_dim();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main.class.getClassLoader()
					.getResourceAsStream(
							"exit/main_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 56774 characters generated by Talend Open Studio for Data Integration on the
 * May 14, 2018 9:17:23 PM MSK
 ************************************************************************************************/
